        ...
        <div id="content">
            ...
            <div className="rol add-patient-container mt-4">
                <div className="col">
                    ...
                    <form onSubmit={handleClick}>
                        <div className="row">
                            ...
                            <div className="col-12 text-end">
                                <button className='btn button-edit-record'><i class="fa-solid fa-pencil button-edit-pencil"></i> Edit</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div className="col ">
                        <h5 className='text-center mb-5 mt-4'>Dental History</h5>
                    </div>
                    ...
                    <table class="table ">
                            ...
                            <tbody>
                                ...
                                <td className='no-bg-color app-today-info' ><button className='btn button-view'>View</button></td>
                                </tr>
                            </tbody>
                            </table>
                    </div>
