...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2025 at 12:10 AM
...
(158, 94, '1', '2024-12-11', '9:00 AM - 10:00 AM', 'finished'),
(159, 94, '1', '2024-12-10', '9:00 AM - 10:00 AM', 'finished'),
(160, 95, '2', '2025-01-17', '11:00 AM - 12:00 PM', 'accepted'),
(168, 106, '12', '2025-01-10', '10:00 AM - 11:00 AM', 'accepted');
...
INSERT INTO `audit_log` (`audit_id`, `user`, `action`, `affected_table`, `record_id`, `new_value`, `timestamp`) VALUES
(4, 'lance', 'Added a user', 'users', NULL, 'adminaaa', '2025-01-09 20:36:09'),
(5, 'lance', 'Added a user', 'users', NULL, 'admasin', '2025-01-10 03:40:59'),
(8, 'lance', 'Edited a user', 'users', '28', 'username = superasd, first name = Lance, last name = Bernal, account type = dentist, password = $2y$10$WmnaV0iyAnJejD1Sq0ApVuFXBYwVJ6VdHv/nR1Mgp44', '2025-01-10 04:07:04'),
(9, 'lance', 'Edited a user', 'users', '27', 'username = adsdas, status = active, first name = sasaasa, last name = xsfd, account type = admin, password = $2y$10$Dcls/zqxCao/Q7UY6IbZ4urCk0rCI.TMfMq58TPmMzv', '2025-01-10 04:13:58'),
(10, 'lance', 'Edited a user', 'users', '27', 'username = adsdas, status = inactive, first name = sasaasa, last name = xsfd, account type = admin, password = $2y$10$Dcls/zqxCao/Q7UY6IbZ4urCk0rCI.TMfMq58TPmMzv', '2025-01-10 04:14:34'),
(11, 'lance', 'Added an appointment', 'appointmen', '105', 'patient ID = 105, patient name = your paret, email = lancewrt@gmail.com, phone number = 09695295926, service = 2, date = 2025-01-10, time = 10:00 AM - 11:00 AM', '2025-01-10 06:03:02'),
(12, 'patient', 'Added an appointment', 'appointment', '106', 'patient ID = 106, patient name = patient appointmern form, email = lancewrt@gmail.com, phone number = 09695295926, service = 12, date = 2025-01-10, time = 10:00 AM - 11:00 AM', '2025-01-10 06:10:01');
...
(106, 'patient', 'appointmern form', 'RABANDABAN', '', 'lancewrt@gmail.com', '09695295926');
...
(27, 'adsdas', '$2y$10$Dcls/zqxCao/Q7UY6IbZ4urCk0rCI.TMfMq58TPmMzv', 'admin', 'sasaasa', 'xsfd', 'inactive'),
(28, 'superasd', '$2y$10$WmnaV0iyAnJejD1Sq0ApVuFXBYwVJ6VdHv/nR1Mgp44', 'dentist', 'Lance', 'Bernal', 'active');
